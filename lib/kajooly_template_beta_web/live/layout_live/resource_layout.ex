...
defmodule KajoolyTemplateBetaWeb.LayoutLive.ResourceLayout do
...
@doc """
  ...
  """
  def resource_resume(assigns) do
    ~H"""
      ...
      <div class="col-12 col-md-6 col-lg-7">
        <div class="card  shadow mb-2">
          ...
          <div class="card-body w-100  p-2">
            ...
            <%= if length(assigns[:list_roles]) > 0 do %>
              <%= for rol <-  assigns[:list_roles] do %>
                <% #= inspect rol %>
                <% id = gen_id_key() %>
    ...
    <div class="col-12 col-md-6 col-lg-5">
      <div class="card shadow">
        ...
        <div class="card-body w-100  p-2">
        <%= if length(assigns.list_activity) > 0 do %>

          <.list let={entry} list={assigns.list_activity}>
  ...
  def resource_tab_actions (assigns) do
  ...
  def resource_tab_rol (assigns) do
  ...
  def resource_tab_rol_edit (assigns) do
    #{Routes.resource_resource_activity_filter_path(@socket, :resource_activity_f_edit, @resource_id,  entry[:id])}
  ...
  def resource_list_index (assigns) do
    ~H"""
      <.breadcrum >
        <%= assigns[:txt_title] %>
       ...
       <div class="col-12 col-md-3 d-none d-lg-block me-auto ">
         <div class="card rounded-3 border-warning text-warning">
           <div class="card-body p-1 d-flex ps-2">
             <.icons_window_stack class="flex-2 mt-2 mxms-2 -e " width="64" height="64" />
             <div class="flex-1">
               <h3 class="m-0 text-warning text-center"><%= assigns[:txt_count] || "[0]" %> </h3>
         ...
         <div class="card">
           <div class="card-body">
               <h4 class="header-title">Sistema de recursos </h4>
               <p class="sub-header">Administre en esta sección los <code>recursos o módulos</code> disponibles en este <code>servidor</code>. En cada recurso podrá editar los <code>Roles</code> y <code>acciónes</code> con los cuales podrá asignar a los usuarios para el manejo de los niveles de gerarquía en cada <code>recurso</code>.
               </p>
  ...
  def resource_modal_delete (assigns) do
    ~H"""
    <div class="row">
      <div class="col">
