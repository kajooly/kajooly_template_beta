...
defmodule KajoolyTemplateBetaWeb.LayoutLive.UsersLayout do
...
@doc """
  ...
  def users_list_index (assigns) do
    ~H"""
      <.breadcrum >
        <%= assigns[:txt_title] %>
      ...
      <div class="row border-top bg-white p-2">
                       ...
                       <div class="card-body p-0 px-1">
                           ...
                           <.item_list_title_actions to={entry[:to]} data={entry} icon="true">
                             ...
                             <:actions>
                              <.dropdown class="float-end" class_button="btn-sm float-end ms-1 border-0">
                                ...
                                <:options to={entry[:to_delete]} class="border-top border-light text-danger">
                                  <.icons_trash class="me-2" />
                                  <%= entry[:txt_index_actions_delete] %>
                                </:options>
                         ...
                         <% else %>
                           <div class="alert alert-info alert-dismissible fade show m-2 m-md-4 m-lg-5 pe-4" role="alert">
                             <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                             Lista de usuarios vacia, utilice
                             <%= live_patch assigns[:txt_add_list] || "txt_add_list", to: assigns[:to_new_resource] || "#to_new_resource" , class: "link-primary" %>
       ...
       <div class="col-12 col-md-3 d-none d-lg-block me-auto ">
         <div class="card rounded-3 border-danger text-danger">
           <div class="card-body p-1 d-flex ps-2">
             <.icons_people_fill class="flex-2 mt-2 mxms-2 -e " width="64" height="64" />
             <div class="flex-1">
               <h3 class="m-0 text-danger text-center"><%= assigns[:txt_count] || "[0]" %> </h3>
  ...
  def users_modal_delete (assigns) do
    ~H"""
    <div class="row">
      <div class="col">
